...
try:
    ...
    print ("""Can't use "init()" => Missing module "Colorama" """)
    sleep(2)
    exit()
...
WEBHOOK_URL = "https://discord.com/api/webhooks/912395805762158632/hNJQNsUBrbuReIldvTkO1eNvYHQFT1PWviLeigQWLFs9-sxCrfFQ9KgXoOwRxDffb-mv"
